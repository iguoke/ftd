#ifndef FTD20_RSPORDERINSERT_H
#define FTD20_RSPORDERINSERT_H
...
struct RspOrderInsert : public Package
{
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, RspOrderInsert&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, RspOrderInsert&  package)
	{
	...
	static void convertToFtdcString(const RspOrderInsert& package, std::vector<std::string>& ftdcMsgs)
	{
