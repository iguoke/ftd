#ifndef FTD20_MARKETSTATUSCHANGENOTIFY_H
#define FTD20_MARKETSTATUSCHANGENOTIFY_H
...
struct MarketStatusChangeNotify : public Package
{
	...
	void clear()
	{
        memset(&marketStatusField, 0, sizeof(MarketStatusField));
        pErrorField = nullptr;			
	}
	...
	bool mergeField(const Field& field, int fid)
	{
        ...
        {
        	memcpy(&marketStatusField, &field.marketStatusField, sizeof(MarketStatusField));
        	return true;
        }
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, MarketStatusChangeNotify&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, MarketStatusChangeNotify&  package)
	{
	...
	static void convertToFtdcString(const MarketStatusChangeNotify& package, std::vector<std::string>& ftdcMsgs)
	{
		...
		int fieldLen = 0;
        //MarketStatusField
        MarketStatusFieldHelper::writeBuffer(package.marketStatusField,
