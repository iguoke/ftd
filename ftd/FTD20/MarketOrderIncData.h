...
#ifndef FTD20_MARKETORDERINCDATA_H
#define FTD20_MARKETORDERINCDATA_H
...
struct MarketOrderIncData : public Package
{
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, MarketOrderIncData&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, MarketOrderIncData&  package)
	{
	...
	static void convertToFtdcString(const MarketOrderIncData& package, std::vector<std::string>& ftdcMsgs)
	{
