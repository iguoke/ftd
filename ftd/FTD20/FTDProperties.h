...
namespace FTD20 {
	...
	typedef   FTD::FTDStringType<80>           TPropertyAbstract;
	typedef   FTD::TFTDLocalId                TPropertyActionLocalId;
	typedef   FTD::TFTDDate                   TPropertyActionDate;
	typedef   FTD::TFTDTime                   TPropertyActiveTime;
	typedef   FTD::TFTDUserId                 TPropertyActiveUserId;
	typedef   FTD::TFTDValue                  TPropertyAddValue;
	typedef   FTD::TFTDVolume                 TPropertyAskLot;
	typedef   FTD::TFTDPrice                  TPropertyAskPrice;
	typedef   FTD::TFTDBoolFlag               TPropertyAutoSuspend;
	typedef   FTD::TFTDPrice                  TPropertyAveragePrice;
	typedef   FTD::TFTDValue                  TPropertyBalanceValue;
	typedef   FTD::TFTDVolume                 TPropertyBidLot;
	typedef   FTD::TFTDPrice                  TPropertyBidPrice;
	typedef   FTD::TFTDDateTime               TPropertyBroadcastLoginTime;
	typedef   FTD::TFTDDateTime               TPropertyBroadcastLogOutTime;
	typedef   FTD::FTDIntType                TPropertyBroadcastSequenceNo;
	typedef   FTD::FTDWordType               TPropertyBroadcastSequenceSeries;
	typedef   FTD::TFTDBoolFlag               TPropertyBroadcastStreamStatus;
	typedef   FTD::TFTDValue                  TPropertyBuyHedgeOffsetMargin;
	typedef   FTD::TFTDValue                  TPropertyBuyHedgeOffsetProfit;
	typedef   FTD::TFTDValue                  TPropertyBuyHedgeOpenFrozMargin;
	typedef   FTD::TFTDValue                  TPropertyBuyHedgeOpenUsedMargin;
	typedef   FTD::TFTDVolume                 TPropertyBuyHedgePosition;
	typedef   FTD::TFTDValue                  TPropertyBuyHedgeTurnOver;
	typedef   FTD::TFTDVolume                 TPropertyBuyHedgeVolume;
	typedef   FTD::TFTDVolume                 TPropertyBuyOffsHPosition;
	typedef   FTD::TFTDVolume                 TPropertyBuyOffsSPosition;
	typedef   FTD::TFTDValue                  TPropertyBuySpecOffsetMargin;
	typedef   FTD::TFTDValue                  TPropertyBuySpecOffsetProfit;
	typedef   FTD::TFTDValue                  TPropertyBuySpecOpenFrozMargin;
	typedef   FTD::TFTDValue                  TPropertyBuySpecOpenUsedMargin;
	typedef   FTD::TFTDVolume                 TPropertyBuySpecPosition;
	typedef   FTD::TFTDValue                  TPropertyBuySpecTurnOver;
	typedef   FTD::TFTDVolume                 TPropertyBuySpecVolume;
	typedef   FTD::TFTDDate                   TPropertyCancelDate;
	typedef   FTD::TFTDBoolFlag               TPropertyCancelFlag;
	typedef   FTD::TFTDTime                   TPropertyCancelTime;
	typedef   FTD::TFTDDate                   TPropertyClearDate;
	typedef   FTD::TFTDPrice                  TPropertyClearPrice;
	typedef   FTD::TFTDClientId               TPropertyClientId;
	typedef   FTD::TFTDName                   TPropertyClientName;
	typedef   FTD::TFTDClientType             TPropertyClientType;
	typedef   FTD::TFTDPrice                  TPropertyClosePrice;
	typedef   FTD::FTDStringType<20>           TPropertyComeFrom;
	typedef   FTD::TFTDConnectionReference       TPropertyConnectionReference;
	typedef   FTD::FTDStringType<500>          TPropertyContent;
	typedef   FTD::FTDStringType<3>            TPropertyCurrency;
	typedef   FTD::TFTDDataFlowFlag           TPropertyDataFlowFlag;
	typedef   FTD::TFTDValue                  TPropertyDelValue;
	typedef   FTD::TFTDDateTime               TPropertyDialogLoginTime;
	typedef   FTD::TFTDDateTime               TPropertyDialogLogoutTime;
	typedef   FTD::TFTDBoolFlag               TPropertyDialogStreamStatus;
	typedef   FTD::TFTDDirection              TPropertyDirection;
	typedef   FTD::TFTDDate                   TPropertyEndDelvDate;
	typedef   FTD::TFTDDate                   TPropertyEndTrdDate;
	typedef   FTD::TFTDErrorCode              TPropertyErrorCode;
	typedef   FTD::FTDStringType<100>          TPropertyErrorText;
	typedef   FTD::TFTDDateTime               TPropertyExchangeDateTime;
	typedef   FTD::TFTDLocalId                TPropertyExecOrderLocalID;
	typedef   FTD::TFTDSysOrderId             TPropertyExecOrderSysID;
	typedef   FTD::FTDIntType                TPropertyForcedistime;
	typedef   FTD::TFTDForceExitCode          TPropertyForceExitCode;
	typedef   FTD::FTDStringType<100>          TPropertyForceExitMsg;
	typedef   FTD::TFTDLocalId                TPropertyForceGroupId;
	typedef   FTD::FTDStringType<20>           TPropertyFrontId;
	typedef   FTD::TFTDBoolFlag               TPropertyFuseFlag;
	typedef   FTD::TFTDPrice                  TPropertyFuselimit;
	typedef   FTD::FTDIntType                TPropertyFusepersisttime;
	typedef   FTD::FTDStringType<6>            TPropertyFusepoint;
	typedef   FTD::TFTDBoolFlag               TPropertyFuseRights;
	typedef   FTD::TFTDHedgeFlag              TPropertyHedgeFlag;
	typedef   FTD::TFTDPrice                  TPropertyHighLimit;
	typedef   FTD::TFTDPercent                TPropertyHighLimitRate;
	typedef   FTD::TFTDPrice                  TPropertyHighPrice;
	typedef   FTD::TFTDValue                  TPropertyInitMargin;
	typedef   FTD::TFTDDateTime               TPropertyInsertTime;
	typedef   FTD::TFTDStopCode               TPropertyInstrStopCode;
	typedef   FTD::TFTDInstrumentId           TPropertyInstrumentId;
	typedef   FTD::TFTDName                   TPropertyInstrumentName;
	typedef   FTD::TFTDInstrumentStatus       TPropertyInstrumentStatus;
	typedef   FTD::TFTDInstrumentType         TPropertyInstrumentType;
	typedef   FTD::TFTDInstrumentVersion      TPropertyInstrumentVersion;
	typedef   FTD::FTDStringType<20>           TPropertyIpAddr;
	typedef   FTD::TFTDBoolFlag               TPropertyIsLogin;
	typedef   FTD::TFTDVolume                 TPropertyLastLot;
	typedef   FTD::TFTDPrice                  TPropertyLastPrice;
	typedef   FTD::TFTDPrice                  TPropertyLifeHigh;
	typedef   FTD::TFTDPrice                  TPropertyLifeLow;
	typedef   FTD::TFTDPrice                  TPropertyLimitPrice;
	typedef   FTD::TFTDVolume                 TPropertyLongOffsFrozHPosition;
	typedef   FTD::TFTDVolume                 TPropertyLongOffsFrozSPosition;
	typedef   FTD::TFTDVolume                 TPropertyLongOpenFrozHPosition;
	typedef   FTD::TFTDVolume                 TPropertyLongOpenFrozSPosition;
	typedef   FTD::TFTDPrice                  TPropertyLowLimit;
	typedef   FTD::TFTDPercent                TPropertyLowLimitRate;
	typedef   FTD::TFTDPrice                  TPropertyLowPrice;
	typedef   FTD::TFTDPrice                  TPropertyMargin;
	typedef   FTD::TFTDMarketId               TPropertyMarketId;
	typedef   FTD::TFTDBoolFlag               TPropertyMarketMatchDataStatus;
	typedef   FTD::TFTDName                   TPropertyMarketName;
	typedef   FTD::TFTDMarketStatus           TPropertyMarketStatusId;
	typedef   FTD::TFTDMatchCondition         TPropertyMatchCondition;
	typedef   FTD::TFTDDate                   TPropertyMatchDate;
	typedef   FTD::TFTDMatchFlag              TPropertyMatchFlag;
	typedef   FTD::TFTDMatchSession           TPropertyMatchSession;
	typedef   FTD::TFTDTime                   TPropertyMatchTime;
	typedef   FTD::TFTDVolume                 TPropertyMaxLot;
	typedef   FTD::TFTDLocalId                TPropertyMaxOrderLocalId;
	typedef   FTD::TFTDMsgRef                 TPropertyMessageReference;
	typedef   FTD::TFTDVolume                 TPropertyMinimalVolume;
	typedef   FTD::TFTDVolume                 TPropertyMinLot;
	typedef   FTD::FTDStringType<20>           TPropertyName;
	typedef   FTD::TFTDPassword               TPropertyNewPassword;
	typedef   FTD::TFTDNewsType               TPropertyNewsType;
	typedef   FTD::TFTDNewsUrgency            TPropertyNewsUrgency;
	typedef   FTD::TFTDOffsetFlag             TPropertyOffsetFlag;
	typedef   FTD::TFTDPassword               TPropertyOldPassword;
	typedef   FTD::TFTDVolume                 TPropertyOpenInterest;
	typedef   FTD::TFTDPrice                  TPropertyOpenPrice;
	typedef   FTD::TFTDOptionType            TPropertyOptionsType;
	typedef   FTD::TFTDActionFlag             TPropertyOrderActionCode;
	typedef   FTD::TFTDLocalId                TPropertyOrderLocalId;
	typedef   FTD::TFTDOrderStatus            TPropertyOrderStatus;
	typedef   FTD::TFTDSysOrderId             TPropertyOrderSysId;
	typedef   FTD::TFTDOrderType              TPropertyOrderType;
	typedef   FTD::TFTDParticipantId          TPropertyParticipantId;
	typedef   FTD::FTDStringType<80>           TPropertyAbstract;
	typedef   FTD::TFTDName                   TPropertyParticipantName;
	typedef   FTD::TFTDParticipantType        TPropertyParticipantType;
	typedef   FTD::TFTDTradeRight             TPropertyPartiTrdRight;
	typedef   FTD::TFTDPassword               TPropertyPassword;
	typedef   FTD::TFTDPrice                  TPropertyPreClose;
	typedef   FTD::TFTDVolume                 TPropertyPreOpenInterest;
	typedef   FTD::TFTDPrice                  TPropertyPreSettle;
	typedef   FTD::TFTDPrice                  TPropertyPrice;
	typedef   FTD::TFTDDateTime               TPropertyPrivateLoginTime;
	typedef   FTD::TFTDDateTime               TPropertyPrivateLogoutTime;
	typedef   FTD::TFTDBoolFlag               TPropertyPrivateStreamStatus;
	typedef   FTD::TFTDProtocolVersion        TPropertyProtocolVersion;
	typedef   FTD::TFTDPubStyle               TPropertyPubstyle;
	typedef   FTD::TFTDValue                  TPropertyPremium;
	typedef   FTD::TFTDSysOrderId             TPropertyQuoteSysID;
	typedef   FTD::TFTDLocalId                TPropertyQuoteLocalID;
	typedef   FTD::TFTDRequestByType          TPropertyRequestBy;
	typedef   FTD::TFTDRateUnit               TPropertyRateUnit;
	typedef   FTD::TFTDPrice                  TPropertyRatePrice;
	typedef   FTD::TFTDValue                  TPropertySellHedgeOffsetMargin;
	typedef   FTD::TFTDValue                  TPropertySellHedgeOffsetProfit;
	typedef   FTD::TFTDValue                  TPropertySellHedgeOpenFrozMargin;
	typedef   FTD::TFTDValue                  TPropertySellHedgeOpenUsedMargin;
	typedef   FTD::TFTDVolume                 TPropertySellHedgePosition;
	typedef   FTD::TFTDValue                  TPropertySellHedgeTurnOver;
	typedef   FTD::TFTDVolume                 TPropertySellHedgeVolume;
	typedef   FTD::TFTDVolume                 TPropertySellOffsHPosition;
	typedef   FTD::TFTDVolume                 TPropertySellOffsSPosition;
	typedef   FTD::TFTDValue                  TPropertySellSpecOffsetMargin;
	typedef   FTD::TFTDValue                  TPropertySellSpecOffsetProfit;
	typedef   FTD::TFTDValue                  TPropertySellSpecOpenFrozMargin;
	typedef   FTD::TFTDValue                  TPropertySellSpecOpenUsedMargin;
	typedef   FTD::TFTDVolume                 TPropertySellSpecPosition;
	typedef   FTD::TFTDValue                  TPropertySellSpecTurnOver;
	typedef   FTD::TFTDVolume                 TPropertySellSpecVolume;
	typedef   FTD::TFTDTime                   TPropertySendTime;
	typedef   FTD::TFTDSequenceNo             TPropertySequenceNo;
	typedef   FTD::TFTDSequenceSeries         TPropertySequenceSeries;
	typedef   FTD::TFTDServerAppName          TPropertyServerAppName;
	typedef   FTD::TFTDPrice                  TPropertySettlePrice;
	typedef   FTD::FTDCharType                TPropertyShortCutKey;
	typedef   FTD::TFTDVolume                 TPropertyShortOffsFrozHPosition;
	typedef   FTD::TFTDVolume                 TPropertyShortOffsFrozSPosition;
	typedef   FTD::TFTDVolume                 TPropertyShortOpenFrozHPosition;
	typedef   FTD::TFTDVolume                 TPropertyShortOpenFrozSPosition;
	typedef   FTD::TFTDDate                   TPropertyStartDelvDate;
	typedef   FTD::TFTDTime                   TPropertyStartTime;
	typedef   FTD::TFTDDate                   TPropertyStartTrdDate;
	typedef   FTD::TFTDPrice                  TPropertyStopPrice;
	typedef   FTD::TFTDTime                   TPropertySuspendTime;
	typedef   FTD::TFTDPrice                  TPropertyStrikePrice;
	typedef   FTD::TFTDTime                   TPropertyThroughTime;
	typedef   FTD::TFTDPrice                  TPropertyTick;
	typedef   FTD::TFTDTimeOut                TPropertyTimeOut;
	typedef   FTD::FTDNumberType<3>            TPropertyTimeSpan;
	typedef   FTD::TFTDTimeStamp              TPropertyTimeStamp;
	typedef   FTD::FTDIntType                TPropertyTotalMarketMatchData;
	typedef   FTD::TFTDVolume                 TPropertyTotalVolume;
	typedef   FTD::TFTDDate                   TPropertyTradeDate;
	typedef   FTD::TFTDTradeId                TPropertyTradeId;
	typedef   FTD::FTDIntType                TPropertyTradeLot;
	typedef   FTD::TFTDPrice                  TPropertyTradePrice;
	typedef   FTD::TFTDTradeRight             TPropertyTradeRights;
	typedef   FTD::TFTDVolume                 TPropertyTradeTurnover;
	typedef   FTD::TFTDTradeType              TPropertyTradeType;
	typedef   FTD::FTDIntType                TPropertyTradeVolume;
	typedef   FTD::FTDIntType                TPropertyUnit;
	typedef   FTD::TFTDTime                   TPropertyUpdateTime;
	typedef   FTD::FTDStringType<200>          TPropertyURLLink;
	typedef   FTD::TFTDUserId                 TPropertyUserId;
	typedef   FTD::TFTDUserStatus             TPropertyUserStatus;
	typedef   FTD::TFTDUserType               TPropertyUserType;
	typedef   FTD::FTDStringType<30>           TPropertyUnderlyingInstrID;
	typedef   FTD::TFTDVolume                 TPropertyUnderlyingMultiple;
	typedef   FTD::TFTDDate                   TPropertyValidThrough;
	typedef   FTD::TFTDVolume                 TPropertyVolume;
	typedef   FTD::FTDIntType                TPropertyVolumeTotal;
	typedef   FTD::FTDIntType                TPropertyVolumeTotalOrginal;
	typedef   FTD::TFTDVolumeType             TPropertyVolumeType;
	typedef   FTD::TFTDVolume                 TPropertyYdBuyHedgePosition;
	typedef   FTD::TFTDVolume                 TPropertyYdBuyOffsHPosition;
	typedef   FTD::TFTDVolume                 TPropertyYdBuyOffsSPosition;
	typedef   FTD::TFTDVolume                 TPropertyYdBuySpecPosition;
