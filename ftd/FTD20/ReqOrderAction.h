#ifndef FTD20_REQORDERACTION_H
#define FTD20_REQORDERACTION_H
...
struct ReqOrderAction : public Package
{
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, ReqOrderAction&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, ReqOrderAction&  package)
	{
	...
	static void convertToFtdcString(const ReqOrderAction& package, std::vector<std::string>& ftdcMsgs)
	{
