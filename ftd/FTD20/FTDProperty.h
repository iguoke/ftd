...
static int getPropertyTypeID(int property_type_id)
{
	...
	case(PROPERTY_ID_Name): return TYPE_ID_StringType20;  // 名称
	...
	case(PROPERTY_ID_TimeSpan): return TYPE_ID_NumberType3;  // 时区，正数表示东区，负数表示西区
	...
	case(PROPERTY_ID_URLLink): return TYPE_ID_StringType200;  // 此消息的WEB 联结
	...
	case(PROPERTY_ID_UnderlyingInstrID): return TYPE_ID_StringType30;  // 基础商品代码
	...
	case(PROPERTY_ID_YdBuySpecPosition): return TYPE_ID_Volume;  // 前买持仓量(投)
		default:
			return -1;
	}
	return -1;
