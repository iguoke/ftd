...
#ifndef FTD20_RSPQRYMARKETMATCHDATA_H
#define FTD20_RSPQRYMARKETMATCHDATA_H
...
struct RspQryMarketMatchData : public Package
{
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, RspQryMarketMatchData&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, RspQryMarketMatchData&  package)
	{
	...
	static void convertToFtdcString(const RspQryMarketMatchData& package, std::vector<std::string>& ftdcMsgs)
	{
