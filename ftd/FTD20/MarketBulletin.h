#ifndef FTD20_MARKETBULLETIN_H
#define FTD20_MARKETBULLETIN_H
...
struct MarketBulletin : public Package
{
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, MarketBulletin&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, MarketBulletin&  package)
	{
	...
	static void convertToFtdcString(const MarketBulletin& package, std::vector<std::string>& ftdcMsgs)
	{
