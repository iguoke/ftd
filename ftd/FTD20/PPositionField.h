...
#ifndef FTD20_PPOSITIONFIELD_H
#define FTD20_PPOSITIONFIELD_H
...
class PPositionFieldHelper
{
public:
	static void writeBuffer(const PPositionField& field, char* buffer, int& writenLen)
	{
		int data_length = 0;
	...
	static void readBuffer(const char* buffer, PPositionField& field, int& readLen)
	{
		int data_length = 0;
