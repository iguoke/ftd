#ifndef FTD20_INSTRUMENTSTATUSCHANGENOTIFY_H
#define FTD20_INSTRUMENTSTATUSCHANGENOTIFY_H
...
struct InstrumentStatusChangeNotify : public Package
{
	...
	bool mergeField(const Field& field, int fid)
	{
        ...
        {
        	memcpy(&instrumentStatusField, &field.instrumentStatusField, sizeof(InstrumentStatusField));
        	return true;
        }
	...
	static bool onFtdcMessage(const std::string& ftdcMsg, InstrumentStatusChangeNotify&  package)
	{
		FTDCHeader header;
	...
	static bool onFtdcMessage(const FTDCHeader& header, const std::string& ftdcContent, InstrumentStatusChangeNotify&  package)
	{
	...
	static void convertToFtdcString(const InstrumentStatusChangeNotify& package, std::vector<std::string>& ftdcMsgs)
	{
        ...
        InstrumentStatusFieldHelper::writeBuffer(package.instrumentStatusField,
